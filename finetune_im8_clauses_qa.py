...
### Comment out this section if not resuming from checkpoint ###
resume_from_checkpoint = 'lora-alpaca-im8-qa'
...
training_args=transformers.TrainingArguments(
        ...
        eval_steps=200,
        save_steps=200,
        output_dir="lora-alpaca-im8-clauses-qa-10-epochs",
        save_total_limit=3,
...
model.save_pretrained("lora-alpaca-im8-clauses-qa-10-epochs")
